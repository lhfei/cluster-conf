...
//
// Debug information:
// Generated date: Wed Dec 16 14:31:37 CST 2015
...
public class DMR_MOBILE_OUTFACT_DAILY extends SqoopRecord  implements DBWritable, Writable {
  ...
  public String get_out_day() {
    return out_day;
  }
  public void set_out_day(String out_day) {
    this.out_day = out_day;
  }
  public DMR_MOBILE_OUTFACT_DAILY with_out_day(String out_day) {
    this.out_day = out_day;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.out_day = JdbcWritableBridge.readString(8, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(out_day, 8 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.out_day = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.out_all = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.out_day) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, out_day);
    }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.out_day = null; } else {
      this.out_day = __cur_str;
    }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("last_update".equals(__fieldName)) {
      ...
      this.out_day = (String) __fieldVal;
    }
