...
echo "export data to MySQL table PHONE_ACTIVATION_TIME .... "
  sqoop export --connect jdbc:mysql://centos10-84:3306/phone_dashboard --table PHONE_ACTIVATION_TIME  \
...
echo "export data to MySQL table PHONE_NETWORK_HALFHOUR .... "
  sqoop export --connect jdbc:mysql://centos10-84:3306/phone_dashboard --table PHONE_NETWORK_HALFHOUR  \
