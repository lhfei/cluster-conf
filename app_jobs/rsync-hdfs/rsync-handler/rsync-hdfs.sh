...
do
	...
	#done
		...
		ssh cloudland@basic.internal.hadoop.10-148-10-13.scloud.letv.com "/usr/hdp/2.3.2.0-2950/oozie/bin/oozie job -run -config /letv/cloudland/app_jobs/event-collect/job.properties"
done
