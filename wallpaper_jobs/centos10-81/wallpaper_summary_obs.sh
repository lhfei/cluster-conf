...
do
	...
	hive -e "INSERT OVERWRITE TABLE scloud_phone.phone_wallpaper_summary_obs_bk SELECT * FROM scloud_phone.phone_wallpaper_summary_obs WHERE SUMMARY_DATE='$current' ;"
