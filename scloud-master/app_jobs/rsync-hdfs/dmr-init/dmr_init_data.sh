...
do
    ...
    do
        ...
        hql="LOAD DATA INPATH 'hdfs://basic.internal.hadoop.10-148-10-10.scloud.letv.com:8020//user/cloudland/warehouse/phone/datamarts/dmr.db/${tname}/dt=${current}/*' INTO TABLE dmr.${tname} PARTITION (dt=${current});"
        echo $hql
        hive -e "$hql"
