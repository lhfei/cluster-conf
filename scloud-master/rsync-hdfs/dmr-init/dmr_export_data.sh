...
do
  ...
  sqoop export --connect jdbc:mysql://10.148.10.66:3306/phone_dashboard --table DMR_PHONE_OUTFACT_DAILY  \
    --export-dir hdfs://centos10-10.letv.cn:8020/apps/hive/warehouse/scloud_phone.db/dmr_phone_outfact_daily --validate --input-null-string '\\N'  --input-null-non-string '\\N' \
