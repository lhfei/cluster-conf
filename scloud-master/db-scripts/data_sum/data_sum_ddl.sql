...
LOCATION
  'hdfs://webdm-cluster/tmp/yeduowei/sum_user_pv_day_tmp'
TBLPROPERTIES (
  'numPartitions'='1', 
  'numFiles'='32', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_did_use_his'
TBLPROPERTIES (
  'numPartitions'='611', 
  'numFiles'='68910', 
...
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_did_use_his_temp'
TBLPROPERTIES (
  'numPartitions'='7', 
  'numFiles'='2881', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_phone_source_day'
TBLPROPERTIES (
  'numPartitions'='109', 
  'numFiles'='174', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_source_day'
TBLPROPERTIES (
  'numPartitions'='77', 
  'numFiles'='85', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_phone_tags_kpi_f'
TBLPROPERTIES (
  'numPartitions'='122', 
  'numFiles'='122', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_phone_tags_kpi_s'
TBLPROPERTIES (
  'numPartitions'='122', 
  'numFiles'='122', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_phone_tags_kpi_t'
TBLPROPERTIES (
  'numPartitions'='120', 
  'numFiles'='120', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_phone_tags_user_day'
TBLPROPERTIES (
  'numPartitions'='123', 
  'numFiles'='122', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_app_day'
TBLPROPERTIES (
  'numPartitions'='187', 
  'numFiles'='2553', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_app_imei_his_day'
TBLPROPERTIES (
  'numPartitions'='193', 
  'numFiles'='268', 
...
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_app_usage_day'
TBLPROPERTIES (
  'numPartitions'='85', 
  'numFiles'='9097', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_app_user_his_day'
TBLPROPERTIES (
  'numPartitions'='193', 
  'numFiles'='222', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_beat_day'
TBLPROPERTIES (
  'numPartitions'='195', 
  'numFiles'='320', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_env_day'
TBLPROPERTIES (
  'numPartitions'='214', 
  'numFiles'='214', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_event_day'
TBLPROPERTIES (
  'numPartitions'='194', 
  'numFiles'='6146', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_imei_his_day_v2'
TBLPROPERTIES (
  'numPartitions'='188', 
  'numFiles'='379', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_imei_his_day'
TBLPROPERTIES (
  'numPartitions'='193', 
  'numFiles'='357', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_music_play_day'
TBLPROPERTIES (
  'numPartitions'='185', 
  'numFiles'='7420', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_user_his_day'
TBLPROPERTIES (
  'numPartitions'='189', 
  'numFiles'='189', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_sdk_phone_video_play_day'
TBLPROPERTIES (
  'numPartitions'='109', 
  'numFiles'='431', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_user_act_day'
TBLPROPERTIES (
  'numPartitions'='2836', 
  'numFiles'='172759', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_user_login_env_day'
TBLPROPERTIES (
  'numPartitions'='6140', 
  'numFiles'='19906', 
  'last_modified_by'='yaoxiaofen', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_user_play_day'
TBLPROPERTIES (
  'numPartitions'='1176', 
  'numFiles'='273348', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_user_play_summary_day'
TBLPROPERTIES (
  'numPartitions'='2124', 
  'numFiles'='184652', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_user_pv_day'
TBLPROPERTIES (
  'numPartitions'='4763', 
  'numFiles'='21327', 
  'last_modified_by'='yaoxiaofen', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_user_query_day'
TBLPROPERTIES (
  'numPartitions'='3110', 
  'numFiles'='3748', 
  'last_modified_by'='jenkins', 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.RCFileOutputFormat'
LOCATION
  'hdfs://webdm-cluster/user/jenkins/warehouse/data_sum.db/sum_user_uuid_play_day'
TBLPROPERTIES (
  'numPartitions'='3440', 
  'numFiles'='472852', 
  'last_modified_by'='jenkins', 
