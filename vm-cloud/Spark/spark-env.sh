...
########################################################################################
## Hefei Li  --@since Dec 21, 2016
########################################################################################
# Alternate conf dir. (Default: ${SPARK_HOME}/conf)
export SPARK_CONF_DIR=${SPARK_HOME:-//usr/local/cloud/spark-2.1.0-bin-hadoop2.7}/conf
...
#export SPARK_CLASSPATH=/usr/local/cloud/spark-2.1.0-bin-hadoop2.7/jars/*.jar:$MYSQL_DRIVER
